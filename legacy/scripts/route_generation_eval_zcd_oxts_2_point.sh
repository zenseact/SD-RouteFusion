#!/bin/bash
#SBATCH --job-name route_generation_zcd_oxts_eval_2_point
#SBATCH --nodes 1
#SBATCH --gpus 0
#SBATCH --cpus-per-task 24
#SBATCH --time 10-00:00:00
#SBATCH --output /workspaces/%u/slurm/%j_eval_oxts_2_point.out
#SBATCH -p zprodcpu
#SBATCH --no-requeue
#

# Define the output path as a variable
OUTPUT_PATH="/staging/dl_tt/path_prediction/data/all_data/processed_osm_oxts_2_point/zcd_osm_oxts_eval"
...
singularity exec --nv \
   ...
   --pwd /app \
    ...
    python3.11 main.py --input=/staging/dl_tt/path_prediction/data/all_data/dl2_hp_eval_default --num_fp_waypoints=1 --map_query_max_l1=$MAP_QUERY_MAX_L1 --output=$OUTPUT_PATH --dataset=ZCD --location_source=oxts --cache_location=$OSM_CACHE_PATH --workers=24
